    ...
    <table class="adminlist table table-striped wp-list-table widefat fixed pages">
      <thead>
        <tr>
          ...
          <?php echo WDW_FM_Library::ordering('title', $orderby, $order, __('Title', WDFM()->prefix), $page_url, 'column-primary'); ?>
          <?php echo WDW_FM_Library::ordering('default', $orderby, $order, __('Default', WDFM()->prefix), $page_url, 'column-primary'); ?>
        </tr>
      </thead>
      <tbody>
      <?php
          ...
          <tr id="tr_<?php echo $row_data->id; ?>" <?php echo $alternate; ?>>
            ...
            <td class="column-primary" data-colname="<?php _e('Title', WDFM()->prefix); ?>">
              ...
              <div class="row-actions">
                <span><a href="<?php echo $edit_url; ?>"><?php _e('Edit', WDFM()->prefix); ?></a> |</span>
                <span><a href="<?php echo $duplicate_url; ?>"><?php _e('Duplicate', WDFM()->prefix); ?></a> |</span>
                <span class="trash"><a onclick="if (!confirm('<?php echo addslashes(__('Do you want to delete selected item?', WDFM()->prefix)); ?>')) {return false;}" href="<?php echo $delete_url; ?>"><?php _e('Delete', WDFM()->prefix); ?></a></span>
              </div>
              <button class="toggle-row" type="button">
                <span class="screen-reader-text"><?php _e('Show more details', WDFM()->prefix); ?></span>
              </button>
            </td>
            <td class="col_default" data-colname="<?php _e('Default', WDFM()->prefix); ?>">
              <?php
              ...
              ?>
                <img src="<?php echo WDFM()->plugin_url . '/images/' . $default_image . '.png?ver=' . WDFM()->plugin_version . ''; ?>" />
              <?php
              if ($default) {
                ?>
              </a>
			  ...
			  <div class="row">
					...
					<div class="fm-themes-tabs-container">
					  ...
					  foreach($all_params as $pkey => $params) {
						...
						if ($row->version == 1 && $pkey == 'custom_css') {
						  echo '<div class="error inline"><p>' . __('This theme is outdated. Theme Options are only available in new themes provided by Form Maker. You can use Custom CSS panel to edit form styling, or alternatively select a new theme for your form.', WDFM()->prefix) . '</p></div>';
						}
				...
				<div class="fm-preview-form col-md-6 col-sm-7" style="display:none;">
				  <div class="form-example-preview fm-sidebar col-md-12">
					<p><?php _e('Preview', WDFM()->prefix); ?></p>
					<div class="fm-row">
					  <label><?php _e('Pagination Type: ', WDFM()->prefix); ?></label>
					  ...
					  <div class="fm-form" ng-class="{borderRight : AGPBorderRight, borderLeft : AGPBorderLeft, borderBottom : AGPBorderBottom, borderTop : AGPBorderTop}">
						<div ng-show="HPAlign != 'bottom' && HPAlign != 'right'" ng-class="{borderRight : HPBorderRight, borderLeft : HPBorderLeft, borderBottom : HPBorderBottom, borderTop : HPBorderTop, alignLeft : HPAlign == 'left'}" class="fm-form-header">
						  <div ng-show="HIPAlign != 'bottom' && HIPAlign != 'right'" ng-class="{imageRight : HIPAlign == 'right', imageLeft :  HIPAlign == 'left', imageBottom : HIPAlign == 'bottom', imageTop :  HIPAlign == 'top'}" class="himage">
							<img src="<?php echo WDFM()->plugin_url; ?>/images/preview_header.png" />
						  </div>
						  <div ng-class="{imageRight : HIPAlign == 'right', imageLeft :  HIPAlign == 'left', imageBottom : HIPAlign == 'bottom', imageTop :  HIPAlign == 'top'}" class="htext">
							<div class="htitle"><?php _e('Subscribe to our newsletter ', WDFM()->prefix); ?></div>
							<div class="hdescription"><?php _e('Join our mailing list to receive the latest news from our team.', WDFM()->prefix); ?></div>
						  </div>
						  <div ng-show="HIPAlign == 'bottom' || HIPAlign == 'right'" ng-class="{imageRight : HIPAlign == 'right', imageLeft :  HIPAlign == 'left', imageBottom : HIPAlign == 'bottom', imageTop :  HIPAlign == 'top'}" class="himage">
							<img src="<?php echo WDFM()->plugin_url; ?>/images/preview_header.png" />
						  </div>
								...
								<div class="fm-column">
								  <div class="fm-row">
									<div type="type_submitter_mail" class="wdform-field">
									  <div class="wdform-label-section" style="float: left; width: 90px;"><span class="wdform-label"><?php _e('E-mail:', WDFM()->prefix); ?></span><span class="wdform-required">*</span>
									  </div>
								  ...
								  <div class="fm-row">
									<div type="type_country" class="wdform-field">
									  <div class="wdform-label-section" style="float: left; width: 90px;">
										<span class="wdform-label"><?php _e('Country:', WDFM()->prefix); ?></span>
									  </div>
									  <div class="wdform-element-section wdform_select" style=" width: 150px;">
										<select style="width: 100%;" ng-class="{isBG : SBPBackground != '', borderRight : IPBorderRight, borderLeft : IPBorderLeft, borderBottom : IPBorderBottom, borderTop : IPBorderTop}">
										  <option value="Armenia"><?php _e('Armenia', WDFM()->prefix); ?></option>
										</select>
									  </div>
									</div>
								  </div>
								  ...
								  <div class="fm-row">
									<div type="type_radio" class="wdform-field">
									  <div class="wdform-label-section" style="float: left; width: 90px;">
										<span class="wdform-label"><?php _e('Radio:', WDFM()->prefix); ?></span>
									  </div>
										  ...
										  <div style="display: table-cell;">
											<div class="radio-div check-rad">
											  ...
											  <label for="em-rad-op-1" class="mini_label">
												<span ng-class="{borderRight : SCPBorderRight, borderLeft : SCPBorderLeft, borderBottom : SCPBorderBottom, borderTop : SCPBorderTop}"></span><?php _e('option 1', WDFM()->prefix); ?>
											  </label>
											</div>
										  </div>
										</div>
								  ...
								  <div class="fm-row">
									<div type="type_checkbox" class="wdform-field">
									  <div class="wdform-label-section" style="float: left; width: 90px;">
										<span class="wdform-label"><?php _e('Checkbox:', WDFM()->prefix); ?></span>
									  </div>
									  <div class="wdform-element-section" style="display: table;">
										<div style="display: table-row; vertical-align:top">
										  <div style="display: table-cell;">
											<div class="checkbox-div forlabs" ng-class="{isBG : MCCPBackground != ''}">
											  ...
											  <label for="em-ch-op-1" class="mini_label"><span ng-class="{borderRight : MCPBorderRight, borderLeft : MCPBorderLeft, borderBottom : MCPBorderBottom, borderTop : MCPBorderTop}"></span><?php _e('option 1', WDFM()->prefix); ?></label>
											</div>
										  </div>
										</div>
									  </div>
								  ...
								  <div class="fm-row">
									<div type="type_submit_reset" class="wdform-field subscribe-reset">
									  ...
									  <div class="wdform-element-section" style="display: table-cell;">
										<button type="button" class="button button-large fm-button-subscribe" ng-class="{borderRight : SPBorderRight, borderLeft : SPBorderLeft, borderBottom : SPBorderBottom, borderTop : SPBorderTop, borderHoverRight : SHPBorderRight, borderHoverLeft : SHPBorderLeft, borderHoverBottom : SHPBorderBottom, borderHoverTop : SHPBorderTop}" ><?php _e('Submit', WDFM()->prefix); ?></button>
										<button type="button" class="button button-large fm-button-reset" ng-class="{borderRight : BPBorderRight, borderLeft : BPBorderLeft, borderBottom : BPBorderBottom, borderTop : BPBorderTop, borderHoverRight : BHPBorderRight, borderHoverLeft : BHPBorderLeft, borderHoverBottom : BHPBorderBottom, borderHoverTop : BHPBorderTop}"><?php _e('Reset', WDFM()->prefix); ?></button>
									  </div>
									</div>
								  </div>
								  <div class="fm-clear"></div>
                ...
                <style>
                    ...
                    background:url(<?php echo WDFM()->plugin_url; ?>/{{GPBackground}}) {{GPBackgroundRepeat}} {{GPBGPosition1}} {{GPBGPosition2}} !important;
                    ...
                    .fm-form-content select.isBG{
                      background-color: {{IPBGColor}} !important;
                      background-image: url(<?php echo WDFM()->plugin_url; ?>/{{SBPBackground}}) !important;
                    ...
                    background:{{MCCPBGColor}} url(<?php echo WDFM()->plugin_url; ?>/{{MCCPBackground}}) {{MCCPBGRepeat}} {{MCCPBGPos1}} {{MCCPBGPos2}} !important;
                    }
