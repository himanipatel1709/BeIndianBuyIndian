      ...
      if ( !in_array( $i, $disabled_fields ) ) {
        switch ( $type ) {
          ...
          case "type_date": {
            ...
            if ( $value ) {
              if ( !$this->fm_validateDate( $value, $date_format ) ) {
                return array( 'error' => true, 'group_id' => $group_id, 'message' => __( "This is not a valid date format.", WDFM()->prefix ) );
              }
            }
            if ( $required && $value === '' ) {
              $missing_required_field = TRUE;
          ...
          case "type_date_fields": {
            ...
            if ( $required && ( $value0 === '' || $value1 === '' || $value2 === '' ) ) {
              $missing_required_field = TRUE;
            }
            break;
          }
        ...
        if ( $missing_required_field ) {
          return array( 'error' => true, 'group_id' => $group_id, 'message' => addslashes( addslashes( sprintf( __( '%s field is required.', WDFM()->prefix ), $label_label[ $key ] ) ) ) );
        }
